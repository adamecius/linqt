...
void MKL_SparseType::Multiply(const complex<double> a, const vector< complex<double> >& x, const complex<double> b, vector< complex<double> >& y)
{
...
void MKL_SparseType::Rescale(const complex<double> a,const complex<double> b)
{
