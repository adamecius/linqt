...
{	
	...
	MKL_SparseType OP[3];
	OP[0].SetID("HAM"); OP[1].SetID(S_OPR); OP[2].SetID(S_OPL);
...
void printHelpMessage()
{
	std::cout<<"The program should be called with the following options: Label Op1 Op2 numMom scaleFactor shift"<<std::endl<<std::endl;
