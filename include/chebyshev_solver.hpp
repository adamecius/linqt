...
namespace chebyshev
{
    ...
    {
    public:
        MomTable(chebyshev::Configure *conf_)
        {
        ...
        inline chebyshev::Configure Configure() const { return *conf_;};
    ...
    void CorrelationExpansionMoments(Factory &stateFactory, SparseMatrixType &HAM, SparseMatrixType &OPL, SparseMatrixType &OPR, MomTable &cTable);
